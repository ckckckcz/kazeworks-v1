...
export default function AnimatedCrossBanner() {
  ...
  return (
    <div className="w-full h-24 lg:mt-14 flex items-center justify-center relative z-20">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className="relative w-full lg:h-[90px] h-14">
          {/* Background stripe */}
          <div
            className="absolute inset-0 bg-[#32fb00] transform rotate-[2deg] origin-center shadow-lg"
            style={{
              width: "150%",
              left: "-25%",
            }}
